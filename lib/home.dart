          ...
          children: [
            ...
            hasDonated? Padding(padding: const EdgeInsets.all(8.0),
              child:Column(
                ...
                children: [
                  Text(
                    "Thanks for ${amountController.text} $selectedCurrency transaction",
                    style: TextStyle(
...
//           children: [
//             Text(
//               "Thanks for your ${amountController.text} $selectedCurrency transaction",
//               style: TextStyle(
//                   fontSize: 28, fontWeight: FontWeight.bold),
//             ),
//             SizedBox(
